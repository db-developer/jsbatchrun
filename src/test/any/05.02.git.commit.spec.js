...
describe( "05.02.git.commit.spec.js - Testing module 'lib/git/commit.js'", () => {
  const commit = require( "../../lib/git/commit" );

  describe( "Testing exports of module 'git/commit'", () => {
  ...
  describe( "Testing 'id' of module 'git/commit'", () => {
    it( "should be equal to 'commit'", () => {
        expect( commit.id === "commit" ).to.be.ok();
    });
  });
  describe( "Testing function 'help' of module 'git/commit'", () => {
    it( "should be callable without arguments", () => {
        expect(() => { commit.help(); }).not.to.throwException();
        expect( commit.help()).to.be.a( "string" );
    });
  });
  describe( "Testing function 'config' of module 'git/commit'", () => {
    it( "should be callable without arguments", () => {
  ...
  describe( "Testing function 'invoke' of module 'git/commit'", () => {
