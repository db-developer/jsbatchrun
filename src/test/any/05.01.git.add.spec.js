...
describe( "05.01.git.add.spec.js - Testing module 'lib/git/add.js'", () => {
  const add = require( "../../lib/git/add" );

  describe( "Testing exports of module 'git/add'", () => {
  ...
  describe( "Testing 'id' of module 'git/add'", () => {
    it( "should be equal to 'add'", () => {
        expect( add.id === "add" ).to.be.ok();
    });
  });
  describe( "Testing function 'help' of module 'git/add'", () => {
    it( "should be callable without arguments", () => {
        expect(() => { add.help(); }).not.to.throwException();
        expect( add.help()).to.be.a( "string" );
    });
  });
  describe( "Testing function 'config' of module 'git/add'", () => {
    it( "should be callable without arguments", () => {
  ...
  describe( "Testing function 'invoke' of module 'git/add'", () => {
