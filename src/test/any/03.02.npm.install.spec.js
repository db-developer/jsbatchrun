...
describe( "03.01.npm.dependency.spec.js - Testing module 'lib/npm/install.js'", () => {
  const inst = require( "../../lib/npm/install" );

  describe( "Testing exports of module 'npm/install'", () => {
  ...
  describe( "Testing 'id' of module 'npm/install'", () => {
    it( "should be equal to 'install'", () => {
        expect( inst.id === "install" ).to.be.ok();
    });
  });
  describe( "Testing function 'help' of module 'npm/install'", () => {
    it( "should be callable without arguments", () => {
        expect(() => { inst.help(); }).not.to.throwException();
        expect( inst.help()).to.be.a( "string" );
    });
  });
  describe( "Testing function 'config' of module 'npm/install'", () => {
    it( "should be callable without arguments", () => {
  ...
  describe( "Testing function 'invoke' of module 'npm/install'", () => {
    ...
    it( "should be callable with argument 'args' { ... } (complete and valid) and resolve", ( done ) => {
        const projects = [ "project-03", "project-14" ];
