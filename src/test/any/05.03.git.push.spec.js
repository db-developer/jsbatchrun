...
describe( "05.03.git.push.spec.js - Testing module 'lib/git/push.js'", () => {
  const push = require( "../../lib/git/push" );

  describe( "Testing exports of module 'git/push'", () => {
  ...
  describe( "Testing 'id' of module 'git/push'", () => {
    it( "should be equal to 'push'", () => {
        expect( push.id === "push" ).to.be.ok();
    });
  });
  describe( "Testing function 'help' of module 'git/push'", () => {
    it( "should be callable without arguments", () => {
        expect(() => { push.help(); }).not.to.throwException();
        expect( push.help()).to.be.a( "string" );
    });
  });
  describe( "Testing function 'config' of module 'git/push'", () => {
    it( "should be callable without arguments", () => {
  ...
  describe( "Testing function 'invoke' of module 'git/push'", () => {
