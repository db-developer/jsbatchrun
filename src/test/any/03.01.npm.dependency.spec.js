...
describe( "03.01.npm.dependency.spec.js - Testing module 'lib/npm/dependency.js'", () => {
  const dep = require( "../../lib/npm/dependency" );

  describe( "Testing exports of module 'npm/dependency'", () => {
  ...
  describe( "Testing 'id' of module 'npm/dependency'", () => {
    it( "should be equal to 'dependency'", () => {
        expect( dep.id === "dependency" ).to.be.ok();
    });
  });
  describe( "Testing function 'help' of module 'npm/dependency'", () => {
    it( "should be callable without arguments", () => {
        expect(() => { dep.help(); }).not.to.throwException();
        expect( dep.help()).to.be.a( "string" );
    });
  });
  describe( "Testing function 'config' of module 'npm/dependency'", () => {
    it( "should be callable without arguments", () => {
  ...
  describe( "Testing function 'invoke' of module 'npm/dependency'", () => {
    ...
    it( "should be callable with argument 'args' { ... } (complete and valid) and resolve", ( done ) => {
        const projects = [ "project-00", "project-01", "project-02"];
